...
#
# Generated onThu Mar 31 06:57:04 PDT 2016# Start of user configurable variables
#
LANG=C
export LANG
...
rm -f sso.out
  ...
  $WGET  --user-agent="Mozilla/5.0" --no-check-certificate --load-cookies=$COOKIE_FILE --save-cookies=$COOKIE_FILE --keep-session-cookies "https://edelivery.oracle.com/osdc/download?fileName=V46005-01.zip&token=" -O $OUTPUT_DIR/V46005-01.zip >> $LOGFILE 2>&1 
